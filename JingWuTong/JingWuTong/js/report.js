...
function createDataTable() {
    ...
    try
    {
       ...
       var columns = [
                 ...
                 { "data": "cloum12", "visible": false },
                 { "data": "cloum13", "visible": false },
                 { "data": "cloum14", "visible": false },
                 { "data": "cloum15", "visible": false },
                 { "data": "cloum16", "visible": false },
                 { "data": "cloum17", "visible": false },
                 { "data": "cloum18", "visible": false },
                 { "data": "cloum19", "visible": false },
                 { "data": "cloum20", "visible": false },
                 { "data": "cloum21", "visible": false },
                 { "data": "cloum22", "visible": false },
                 { "data": "cloum23", "visible": false },
                 { "data": "cloum24", "visible": false },
                 { "data": "cloum25", "visible": false },
                 { "data": "cloum26", "visible": false },
                 { "data": "cloum27", "visible": false },
                 { "data": "cloum28", "visible": false },
                 { "data": "cloum29", "visible": false },
                 { "data": "cloum30", "visible": false },
                 { "data": "cloum31", "visible": false },
                 { "data": "cloum32", "visible": false }
  ...
  "<th colspan='8' style='text-align:center'>" + $(".start_form_datetime").val() + "-" + $(".end_form_datetime").val() + "" + brigade + "" + squadron + "" + $("#deviceselect").find("option:selected").text() + "分时段统计汇总</th>" +
                 "</tr>" +
                  "<tr>" +
                        "<th rowspan='2' style='text-align:center'>警员姓名</th>" +
                      "<th rowspan='2' style='text-align:center'>警员编号</th>" +
                      "<th rowspan='2' style='text-align:center'>呼号</th>" +
                       "<th style='text-align:center'>" + arry[0] + "</th>" +
                       "<th  style='text-align:center'>" + arry[1] + "</th>" +
                        "<th  style='text-align:center'>" + arry[2] + "</th>" +
                        "<th  style='text-align:center'>" + arry[3] + "</th>" +
